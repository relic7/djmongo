"""
Starter fabfile for deploying the djmongo project.
...
# CHANGEME
env.hosts = ['user@djmongo.example.com']
env.code_dir = '/srv/www/djmongo'
env.project_dir = '/srv/www/djmongo/djmongo'
env.static_root = '/srv/www/djmongo/static/'
env.virtualenv = '/srv/www/djmongo/.virtualenv'
env.code_repo = 'git@github.com:user/djmongo.git'
env.django_settings_module = 'djmongo.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/djmongo/wsgi.py" % env.code_dir)
