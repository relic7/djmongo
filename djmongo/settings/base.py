...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'djmongo.settings.base.custom_show_toolbar',
...
SYSTEM_EMAIL_PREFIX = "[djmongo]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_djmongo"  # Make this unique to your project.
